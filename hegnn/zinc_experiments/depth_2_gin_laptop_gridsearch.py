...
grid = [n_hops_iter, dropout_iter, n_layers_iter]

for settings in product(*grid):
    n_hops, dropout, n_layers = settings
    result_dict = {}
    ...
    cur_config.run_name = (
        f"ZINCGIN_run_{run_index}_n_hops_{n_hops}_dropout_{dropout}_layers_{n_layers}"
    )
